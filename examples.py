...
for i in range(0, 3):
    ...
    ic.create_screwImage(mask_dir='Masks', ouput_dir='generated_ImageLabel', image_name = 'generated_image', number_generated_objects=40, number_generated_otherScrews=40, number_generated_shapes=30, disturbanceBackground=False, ImageSave=True)
